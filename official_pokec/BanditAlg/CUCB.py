    ...
    def updateParameters(self, S, live_nodes, live_edges, iter_): 
        ...
        for u in live_nodes:
            for (u, v) in self.G.edges(u):
                #print(self.G.has_edge(u,v))
                #print((u, v) in self.G.edges())
                #print((u, v) in self.arms)
                #print((v, u) in self.arms)
                #if self.arms[(u,v)]==None:
                #    raise ValueError("arm construction error")
