            ...
            for alg_name, alg in list(algorithms.items()): 
                ...
                for (u,v) in live_edges.keys():
                    ...
                    if G.has_edge(u,v)==False:
                        raise ValueError("IC error, live_edges not in G.edges")
...
if __name__ == '__main__':
    ...
    G = nx.DiGraph(G)
    #edges = G.edges()
    #transformed_edges = [(edge[0], edge[1]) for edge in edges]
    #G.clear()
    ...
    #print(G.node(127))
    #print([(127,1356)] in G.edges())
    #print([(127,1356)] in P.edges())
    #print(G[0])
    #for i in G[0]:
    #    print([i])
    #print(G[127])
